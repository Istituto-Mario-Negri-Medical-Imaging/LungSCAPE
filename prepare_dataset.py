...
def main():
    ...
    print(f"       python run_model201.py <model201_base_dir>")
    print(f"       Rename output to {{PatientID}}_airways201.nii.gz in DATA/PatientID/")
    print(f"    3. Run nnU-Net Model191 (high attenuation, optional):")
    print(f"       python setup_model191.py <model191_base_dir>   # first time only")
    print(f"       python run_model191.py <model191_base_dir>")
    print(f"       Rename output to {{PatientID}}_HighAttenuation.nii.gz in DATA/PatientID/")
